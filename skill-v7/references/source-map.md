# Vibecode Kit v7 — Source Map

Mục tiêu của file này là phân biệt rõ: phần nào là phương pháp nội bộ Vibecode, phần nào đến từ tài liệu Nexus của người dùng, phần nào là best practice bên ngoài có nguồn xác thực, và phần nào chỉ là heuristic cần kiểm chứng thêm.
...
|---|---|---|---|---|
| Chủ nhà / Chủ thầu / Thợ thi công | `skill-v6/SKILL.md` | Vibecode internal | Power Triangle trong v6 | Giữ như ngôn ngữ giải thích, nhưng chuyển từ platform role sang responsibility role. |
| Power Triangle | `skill-v6/SKILL.md` | Vibecode internal | Chủ nhà quyết định, Chủ thầu thiết kế, Thợ thi công implement | Giữ tinh thần phân quyền, bỏ gắn cứng Claude Chat / Claude Code. |
| SCAN | `skill-v6/SKILL.md`, `tip-and-report-formats.md` | Vibecode internal + coding-agent practice | Builder scan codebase trước khi thiết kế | Giữ, đổi thành Evidence Scan / Codebase Brief compact. |
| RRI | `skill-v6/references/rri-methodology.md` | Vibecode internal | “I see it like this — correct?” | Giữ lõi, đổi từ fixed 40–60 questions sang risk-based clarification. |
| 5 RRI personas | `rri-methodology.md`, `rri-question-bank.md` | Vibecode internal heuristic | End User, BA, QA, Developer, Operator | Giữ như lens tùy chọn; không bắt buộc mọi task phải đủ 5 persona. |
| RRI-T / RRI-UX / RRI-UI | `rri-methodology.md` | Vibecode internal heuristic | 5 personas × dimensions × stress axes | Giữ như protocol nâng cao; chỉ dùng khi QA/UX scope yêu cầu. |
| TIP | `tip-and-report-formats.md` | Vibecode internal | Task Instruction Pack | Thay bằng Execution Card compact; full TIP chỉ dùng khi handoff/risk cao. |
| Completion Report | `tip-and-report-formats.md` | Vibecode internal | DONE/PARTIAL/BLOCKED report | Thay bằng compact report mặc định; full report chỉ khi fail/block/deviation. |
| Verify Report | `tip-and-report-formats.md`, `qa-protocol.md` | Vibecode internal + QA traceability | Requirement coverage, scenario results, health checks | Giữ, đổi thành Verify Ledger compact + full Verify Report khi milestone/risk. |
| Debug Protocol | `debug-protocol.md` | Vibecode internal, dựa trên debugging discipline phổ biến | Evidence → hypotheses → root cause → fix → verify | Giữ gần như nguyên tắc; output compact trừ khi blocked/fail. |
| QA tiers | `qa-protocol.md` | Generic QA best practice / Vibecode packaging | Tier 1 core, Tier 2 robustness, Tier 3 performance/security | Giữ; ghi rõ đây là Vibecode packaging của QA practice phổ biến. |
...
| Runtime tooling (`vibe new`, `vibe verify`) | `CURRENT_VERSION.md` roadmap | Aspirational Vibecode roadmap | v6 ghi “No runtime tooling” | Không triển khai trong v7 docs-first MVP; chỉ cân nhắc sau case study. |
| Multi-agent orchestration | `CURRENT_VERSION.md` roadmap | Aspirational Vibecode roadmap | Auto-relay TIP/Report nằm ở v7 future của v6 roadmap | Hạ thành optional mode, không mặc định. |
...
- QA tiers hiện là Vibecode packaging; nếu muốn claim theo ISTQB/ISO/IEEE cần bổ sung nguồn riêng.
...
4. Nếu origin là Vibecode internal, ghi rõ là internal heuristic/protocol.
